...
public class Location {
    ...
    private List<LocationTag> locationFK;
    ...
    public List<LocationTag> getLocationFK() {
        if (locationFK == null) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            LocationTagDao targetDao = daoSession.getLocationTagDao();
            List<LocationTag> locationFKNew = targetDao._queryLocation_LocationFK(id);
            synchronized (this) {
                if(locationFK == null) {
                    locationFK = locationFKNew;
                }
            }
        }
        return locationFK;
    ...
    public synchronized void resetLocationFK() {
        locationFK = null;
    }
